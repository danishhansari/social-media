      ...
      <div className="flex flex-col md:flex-row justify-between w-full md:w-[50%] mx-auto items-center">
        ...
        <div className="text">
          ...
          <div className="w-full md:w-[80%]">
            ...
            <button className="text-center py-2 rounded-full w-full my-2 bg-primary text-white font-medium hover:bg-primary/90 transition-colors" onClick={() => setShowPortal(true)}>
              Create account
            </button>
            <p className="text-sm">
