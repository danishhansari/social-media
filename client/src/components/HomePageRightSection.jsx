...
const HomePageRightSection = () => {
  ...
  return (
    <div className="px-8 py-2 w-2/3">
      ...
      <div className="bg-white rounded-md text-black relative z-10 flex flex-col px-4 py-0">
        {users.length > 0 ? (
          users.map((user) => {
            return (
              <Link key={user._id} to={`/${user.username}`} className="hover:bg-lightgrey px-4 py-2">
